...
export class CustomLogger implements LoggerService {
    ...
    warn(message: string, context?: string, additionalData?: Record<string, any>) {
        this.printLog("WARN", message, context, additionalData);
    }

    debug(message: string, context?: string, additionalData?: Record<string, any>) {
        this.printLog("DEBUG", message, context, additionalData);
    }

    verbose(message: string, context?: string, additionalData?: Record<string, any>) {
