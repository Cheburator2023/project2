		...
		example: {
			...
			generalUncertainty: {
				businessProcessComplexity: {
					...
					influence: "Реализация проекта с контролируемыми отклонениями от изначальных целей"
				},
				...
				planningRequirementGaps: {
					...
					influence: "Значительный негативный эффект на возможность достижения целей проекта"
				},
