...
export class ExcelExportService {
    async generateExcelFile(calculations: Calculation[]): Promise<Buffer> {
        ...
        worksheet.columns = [
            ...
            { header: "03. Построение витрины для разработки", key: "stage03", width: 30 },
            ...
            { header: "Общая неопределенность", key: "generalUncertainty", width: 30 },
            { header: "Риск: Изменение бизнес-процессов Банка", key: "riskBusinessProcess", width: 40 },
            { header: "Риск: Наличие дефектов во внедряемом решении", key: "riskSolutionDefects", width: 40 },
            { header: "Риск: Влияние смежных проектов", key: "riskAdjacentProjects", width: 40 },
            { header: "Риск: Увеличение трудозатрат проекта", key: "riskPlanningGaps", width: 40 },
            { header: "Риск: Недобросовестное исполнение услуг", key: "riskContractorPerformance", width: 40 },
            { header: "Риск: Отсутствие квалифицированного персонала", key: "riskStaffShortage", width: 40 },
            { header: "Риск: Введение санкционных мер", key: "riskSanctions", width: 40 },
            { header: "Риск: Недостаток контрольных процедур", key: "riskControlProcedures", width: 40 },
            { header: "Риск: Изменение регуляторных требований", key: "riskRegulatoryChanges", width: 40 },
            { header: "Риск: Неиспользование ИС после завершения проекта", key: "riskSystemUnderutilization", width: 40 },
            { header: "Риск: Изменение целевой ИТ архитектуры", key: "riskItArchitecture", width: 40 },
        ...
        { header: "Сложность алгоритма/тип ML задачи", key: "algorithmComplexity", width: 35 },
        { header: "Тип алгоритма: Табличные данные", key: "algorithmTabular", width: 30 },
        { header: "Тип алгоритма: Текстовая аналитика_Классические модели", key: "algorithmTextClassic", width: 45 },
        { header: "Тип алгоритма: Текстовая аналитика_LLM", key: "algorithmTextLLM", width: 35 },
        { header: "Тип алгоритма: Аудио аналитика", key: "algorithmAudio", width: 30 },
        { header: "Тип алгоритма: Компьютерное зрение_CV", key: "algorithmCV", width: 35 },
        { header: "Тип алгоритма: Оптимизационная задача", key: "algorithmOptimization", width: 35 },
        { header: "Тип алгоритма: Гео-аналитика", key: "algorithmGeo", width: 30 },
        { header: "Тип алгоритма: Графовая аналитика", key: "algorithmGraph", width: 30 },
        ...
        { header: "Необходимость продуктивизации и каналы внедрения моделей", key: "productionDeploymentChannels", width: 50 },
        { header: "Канал внедрения: Батч", key: "deploymentBatch", width: 25 },
        { header: "Канал внедрения: Батч + загрузка данных потребителю", key: "deploymentBatchLoad", width: 40 },
        { header: "Канал внедрения: Батч + Онлайн", key: "deploymentBatchOnline", width: 30 },
        { header: "Канал внедрения: Онлайн", key: "deploymentOnline", width: 25 },
        { header: "Канал внедрения: Онлайн gpu", key: "deploymentOnlineGpu", width: 30 },
        { header: "Канал внедрения: Стриминг", key: "deploymentStreaming", width: 25 },
        { header: "Канал внедрения: Мобильные устройства", key: "deploymentMobile", width: 30 },
        { header: "Канал внедрения: LLM", key: "deploymentLLM", width: 25 },
        { header: "Канал внедрения: Гео-сервисы", key: "deploymentGeoServices", width: 30 },
        { header: "Канал внедрения: Внедрение в облаке", key: "deploymentCloud", width: 30 },
        { header: "Канал внедрения: Графовая платформа", key: "deploymentGraph", width: 30 },
    ];
