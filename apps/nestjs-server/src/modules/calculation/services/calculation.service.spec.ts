        ...
        questionnaireData: {
            ...
            generalUncertainty: {
                planningRequirementGaps: {
                    ...
                    influence: "Незначительное влияние на вторичные функции в рамках проектной деятельности"
                },
                businessProcessComplexity: {
                    probability: "Реализация 1 раз в 3-10 лет",
                    influence: "Незначительное влияние на задачи и сроки достижения целей проекта"
                }
            },
        ...
        it("should successfully create a calculation", async () => {
            ...
            expect(repository.create).toHaveBeenCalledWith({
                ...
                questionnaireData: {
                    ...
                    assessedInitiativesCount: mockCreateDto.assessedInitiativesCount?.toString() ?? undefined,
                    ...
                    productionAdditionalReports: mockCreateDto.productionAdditionalReports?.toString(),
                    productionDeploymentChannels: [
                        { deploymentChannel: "Батч" },
                        { deploymentChannel: "Батч+загрузка данных потребителю" }
                    ]
