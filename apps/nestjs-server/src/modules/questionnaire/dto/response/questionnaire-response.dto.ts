...
export class StreamAverageDto {
    @ApiProperty({ example: 15.5, description: 'Среднее значение для этапа "01. Постановка задачи"' })
    '01. Постановка задачи': number;

    @ApiProperty({ example: 20.0, description: 'Среднее значение для этапа "02. Поиск данных"' })
    '02. Поиск данных': number;

    @ApiProperty({ example: 25.0, description: 'Среднее значение для этапа "03. Построение витрины для разработки"' })
    '03. Построение витрины для разработки': number;

    @ApiProperty({ example: 40.0, description: 'Среднее значение для этапа "05А. Разработка пилотной модели (MVP)"' })
    '05А. Разработка пилотной модели (MVP)': number;

    @ApiProperty({ example: 37.0, description: 'Среднее значение для этапа "05. Разработка модели"' })
    '05. Разработка модели': number;

    @ApiProperty({ example: 68.0, description: 'Среднее значение для этапа "AML Разработка"' })
    'AML Разработка': number;

    @ApiProperty({ example: 34.0, description: 'Среднее значение для этапа "05В. Пилотирование модели"' })
    '05В. Пилотирование модели': number;

    @ApiProperty({ example: 56.0, description: 'Среднее значение для этапа "07. Разработка витрины для применения модели"' })
    '07. Разработка витрины для применения модели': number;

    @ApiProperty({ example: 50.0, description: 'Среднее значение для этапа "09. Адаптация и внедрение модели"' })
    '09. Адаптация и внедрение модели': number;

    @ApiProperty({ example: 68.0, description: 'Среднее значение для этапа "AML Внедрение"' })
