...
/** Колонки триггеров на assignment: предыдущая миграция могла быть записана без фактического ALTER. */
export class AddTypicalWorkAssignmentTriggerFields1763610000000
	implements MigrationInterface
{
	name = "AddTypicalWorkAssignmentTriggerFields1763610000000";
