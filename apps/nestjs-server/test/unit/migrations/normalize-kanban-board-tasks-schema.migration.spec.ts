import { NormalizeKanbanBoardTasksSchema1761600000000 } from "../../../src/migrations/1761600000000-NormalizeKanbanBoardTasksSchema";
...
describe("NormalizeKanbanBoardTasksSchema1761600000000", () => {
	it("drops legacy columns and keeps kanban schema columns", async () => {
		...
		await new NormalizeKanbanBoardTasksSchema1761600000000().up(queryRunner);
