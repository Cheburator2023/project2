...
describe('CreateCalculationTable1718651234567', () => {
    ...
    describe('up', () => {
        it('should create calculation table and index', async () => {
            ...
            expect(queryRunner.queries[0]).toContain('CREATE TABLE IF NOT EXISTS calculation');
            expect(queryRunner.queries[1]).toContain('CREATE INDEX idx_calculation_created_at');
        });
    });
    ...
    describe('down', () => {
        it('should drop index and table', async () => {
            ...
            expect(queryRunner.queries.length).toBe(2);
            expect(queryRunner.queries[0]).toContain('DROP INDEX idx_calculation_created_at');
