...
describe('CreateQuestionnaireSchema1718651234568', () => {
    ...
    describe('up', () => {
        it('should execute correct queries in order', async () => {
            ...
            expect(queries[0]).toContain('CREATE TABLE IF NOT EXISTS questionnaire_item');
    ...
    describe('down', () => {
        it('should drop all tables', async () => {
            ...
            expect(queryRunner.queries[0]).toContain('DROP TABLE IF EXISTS stream_average');
            expect(queryRunner.queries[1]).toContain('DROP TABLE IF EXISTS coefficient');
            expect(queryRunner.queries[2]).toContain('DROP TABLE IF EXISTS questionnaire_item');
        });
    });
});