...
import { testQuestionnaireItem, testCoefficient, testStreamAverage } from '../../../../test-data';
...
describe('QuestionnaireService', () => {
    ...
    beforeEach(async () => {
                        ...
                        find: jest.fn().mockImplementation((options) => {
                            if (options.where.code === 'risk_%') {
                                return Promise.resolve([{
                                    ...
                                    code: 'risk_5_1',
                                    baseValue: 1.0,
                                    conditions: { conditions: [{ field: 'test', value: 'test' }] }
                                }]);
                            }
                            return Promise.resolve([{
                                ...testCoefficient,
        ...
        referenceDataService = module.get<ReferenceDataService>(ReferenceDataService);
    });
    ...
    describe('getFullQuestionnaire', () => {
        it('should handle risk items correctly', async () => {
            const riskItem = {
                ...
                fieldType: 'risk',
                options: [{ value: '5.1', label: 'Risk 1', hint: 'Risk description 1' }]
            };
