...
PATCHES: dict[str, dict] = {
	...
	"07|Разработка витрины для применения модели": {
		...
		"triggerFormula": formula(
			...
			"Необходимость продуктивизации и количество дополнительных витрин ≠ Не требуется И (Необходимость поддержки проведения пилота = Да ИЛИ Тип работ ∈ {Разработка, Внедрение, Разработка и внедрение})",
		),
