...
export interface FilterModelHelpers {
	...
	) => filter is NumberFilterCondition;
	...
	isCombinedFilter: (
		filter: ColumnFilterModel,
	) => filter is CombinedFilterCondition;
...
export const filterModelHelpers: FilterModelHelpers = {
	...
	getActiveFiltersCount: (filterModel) => Object.keys(filterModel || {}).length,

	getFilteredColumns: (filterModel) => Object.keys(filterModel || {}),
