...
describe("General Uncertainty Coefficient Calculation (new logic)", () => {
	...
	describe("calculation steps", () => {
		...
		it.each([
			["Неприемлемая", "Очень высокая", "Очень высокий"],
			["Неприемлемая", "Высокая", "Очень высокий"],
			["Неприемлемая", "Средняя", "Очень высокий"],
			["Неприемлемая", "Низкая", "Высокий"],
			["Неприемлемая", "Очень низкая", "Средний"],
			["Высокая", "Очень высокая", "Очень высокий"],
			["Высокая", "Высокая", "Очень высокий"],
			["Высокая", "Средняя", "Высокий"],
			["Высокая", "Низкая", "Средний"],
			["Высокая", "Очень низкая", "Средний"],
			["Существенная", "Очень высокая", "Очень высокий"],
			["Существенная", "Высокая", "Высокий"],
			["Существенная", "Средняя", "Высокий"],
			["Существенная", "Низкая", "Средний"],
			["Существенная", "Очень низкая", "Низкий"],
			["Средняя", "Очень высокая", "Высокий"],
			["Средняя", "Высокая", "Высокий"],
			["Средняя", "Средняя", "Средний"],
			["Средняя", "Низкая", "Низкий"],
			["Средняя", "Очень низкая", "Низкий"],
			["Низкая", "Очень высокая", "Средний"],
			["Низкая", "Высокая", "Средний"],
			["Низкая", "Средняя", "Низкий"],
			["Низкая", "Низкая", "Низкий"],
			["Низкая", "Очень низкая", "Низкий"],
		] as const)(
			"maps impact=%s and probability=%s to risk=%s",
			(impact, probability, expected) => {
				expect(calculateRiskLevelAssessment(impact, probability)).toBe(
					expected,
				);
			},
		);
