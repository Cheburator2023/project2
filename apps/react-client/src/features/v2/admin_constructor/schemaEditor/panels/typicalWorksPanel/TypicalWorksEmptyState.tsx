	...
	return (
		...
		>
			...
			>
				...
				>
					Типовые работы хранятся в общем справочнике. Выберите нужные и
					назначьте на эту область — у каждой работы будут свои нормативы и
					логика именно для этого стрима.
				</Typography>
				<Box
					sx={{
						display: "flex",
