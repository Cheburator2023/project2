import Input from "@react-client/common/forms/masks/Input";
import SyntheticChangeError from "@react-client/common/forms/masks/SyntheticChangeError";
...
export default class Mask extends Input<{
	...
	static {
		Object.defineProperty(Mask.prototype, Symbol.toStringTag, {
			writable: false,
			enumerable: false,
			configurable: true,
			value: "Mask",
