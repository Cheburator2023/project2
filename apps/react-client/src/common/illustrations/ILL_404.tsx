	...
	return (
		<Flex position="relative" data-test-id="--Flex-0">
			...
			<svg
				...
				data-test-id="--svg-0"
			>
				<title data-test-id="--title-0">void</title>
				<ellipse
					cx="308.5"
					cy="780"
					rx="308.5"
