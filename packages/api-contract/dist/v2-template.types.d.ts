 ...
 */
export declare const V2_TEMPLATE_STATUS_VALUES: readonly ["draft", "published", "archived"];
export type V2TemplateStatus = (typeof V2_TEMPLATE_STATUS_VALUES)[number];
export declare const V2_TEMPLATE_AUDIT_ACTION_VALUES: readonly ["template.created", "template.updated", "template.deleted", "version.created", "version.updated", "version.published", "version.archived", "version.rolled_back", "version.reset_to_default", "version.activated_as_current", "version.deleted", "dictionary.created", "dictionary.updated", "dictionary.deleted", "dictionary_item.created", "dictionary_item.updated", "dictionary_item.deleted"];
export type V2TemplateAuditAction = (typeof V2_TEMPLATE_AUDIT_ACTION_VALUES)[number];
/**
 ...
 */
export declare const V2_LOGIC_RULE_KIND_VALUES: readonly ["visibility", "required", "computed", "row_computed", "validation", "hint", "task_trigger"];
export type V2LogicRuleKind = (typeof V2_LOGIC_RULE_KIND_VALUES)[number];
export type V2JsonLogicValue = string | number | boolean | null | V2JsonLogicValue[] | {
...
export type V2DictionaryBulkFailureReason = "not_found" | "default_dictionary" | "in_use" | "not_default" | "reset_failed";
...
export type BulkV2DictionaryJsonResponseDto = Record<string, V2DictionaryJsonSnapshotDto>;
...
export declare const V2_VALIDATION_ISSUE_LEVEL_VALUES: readonly ["error", "warning", "info"];
export type V2ValidationIssueLevel = (typeof V2_VALIDATION_ISSUE_LEVEL_VALUES)[number];
 ...
 */
export declare const V2_MAX_JSON_SCHEMA_BYTES = 1048576;
/**
 * Максимальное число правил в logic graph.
 */
export declare const V2_MAX_LOGIC_RULES = 5000;
export declare const V2_CALC_ROLE_VALUES: readonly ["typical_total", "atypical_total", "grand_total", "coefficient", "stage_value", "other"];
