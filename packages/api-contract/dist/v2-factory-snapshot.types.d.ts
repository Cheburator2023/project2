import type { V2DictionariesSnapshotDto, V2JsonSchemaDto, V2LogicGraphDto, V2UiSchemaDto } from "./v2-template.types";
import type { V2TypicalWorkCardDto } from "./v2-typical-work.types";
export declare const V2_FACTORY_SNAPSHOT_SOURCE_VALUES: readonly ["builtin", "template"];
export type V2FactorySnapshotSource = (typeof V2_FACTORY_SNAPSHOT_SOURCE_VALUES)[number];
