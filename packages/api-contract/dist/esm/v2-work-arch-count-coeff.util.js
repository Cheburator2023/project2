...
export function formatArchCountCoeffFactorLabel(kind) {
...
export function resolveLaborArchCountOperator(step) {
    return step.operator ?? "=";
}
export function compareArchCount(actual, operator, threshold) {
    switch (operator) {
        case ">=":
 ...
 */
export function evalArchCountCoefficientFormula(formula, n) {
...
export function validateArchCountCoefficientFormula(formula, sampleN) {
...
export function formatLaborArchCountStepLabel(step) {
    const operator = resolveLaborArchCountOperator(step);
