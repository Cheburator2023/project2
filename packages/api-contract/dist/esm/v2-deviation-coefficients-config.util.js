import { V2_MODEL_STREAM_FACTORY_WORK_IDS, } from "./v2-model-stream-typical-works.constants";
export const V2_DEVIATION_COEFFICIENTS_CONFIG_RULE_ID = "__v2_deviation_coefficients_config__";
export const V2_DEVIATION_COEFFICIENTS_CONFIG_PAYLOAD_ROLE = "deviation_coefficients_config";
...
export function createDefaultDeviationCoefficientsConfig() {
    return {
        version: 1,
...
export function isDeviationCoefficientsConfigLogicRule(rule) {
    if (rule.id === V2_DEVIATION_COEFFICIENTS_CONFIG_RULE_ID)
        return true;
...
export function parseDeviationCoefficientsConfigFromLogic(rules) {
...
export function buildDeviationCoefficientsConfigLogicRule(config) {
    return {
...
export function mergeDeviationCoefficientsConfigIntoLogic(rules, config) {
...
export function resolveSourceCountCoefficient(config, dataSourceCount) {
...
export function resolveAlgorithmTypeCoefficient(config, algorithmTypes) {
...
export function resolveDeploymentChannelCoefficient(config, channels) {
