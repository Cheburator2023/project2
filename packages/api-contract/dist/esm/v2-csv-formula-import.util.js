...
export function isCsvModelServiceCreateTrigger(paramName) {
...
export function mapCsvControlTypeValue(raw) {
...
export function buildFormulaTextFromCsvCore(core, resolveParamCode, preferLaborLabels) {
...
export function csvRowToCatalogPatch(row, candidates, overrides = {}) {
    ...
    const allowedParamCodes = new Set(laborParams.flatMap((paramName) => {
        ...
        const aliasSlug = slugParamCode(CSV_PARAM_LABEL_ALIASES[normalizeParamLabel(paramName)] ?? paramName);
