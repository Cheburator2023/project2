...
import { buildV2QuestionnaireRegistryExportRow, formatV2RegistryExportCellValue, } from "./v2-questionnaire-registry-export.util";
describe("v2-questionnaire-registry-export.util", () => {
    ...
    it("builds export row with registry and form fields", () => {
        ...
        expect(exported["form.detailInfo.parameters.streamNames"]).toBe("Alpha, Beta");
    });
});
