import { kanbanBoardPriorityTitle, kanbanBoardSubtaskIsDone, kanbanBoardSubtaskStatusTitle, kanbanBoardTaskTypeTitle, kanbanBoardWorkTypeTitle, } from "./kanban-board.types";
...
export function formatKanbanBoardHistoryValue(value) {
...
export function diffKanbanTaskChanges(before, after, labels) {
    const changes = [];
