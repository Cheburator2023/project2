...
import { buildBooleanVisibilityRule, v2JsonPointerToVarPath, } from "./v2-logic-rule-builders.util";
describe("v2-logic-rule-builders.util", () => {
    it("maps JSON Pointer to var path", () => {
        expect(v2JsonPointerToVarPath("/detailInfo/parameters/streamsOutsideDADM")).toBe("detailInfo.parameters.streamsOutsideDADM");
    });
