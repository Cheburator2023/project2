...
export const V2_DATA_TRANSFER_SECTION_FILE_SLUGS = {
    templates: "templates",
    dictionaries: "dictionaries",
    typicalWorks: "typical-works",
    questionnaires: "questionnaires",
};
export function formatV2DataTransferExportTimestamp(value = new Date()) {
...
export function buildV2DataTransferExportFilename(sections, exportedAt) {
...
export function expandV2DataTransferExportSections(sections) {
