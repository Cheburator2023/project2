...
export function computeAtypicalWorkRowTotal(estimateHoursPerDay, coefficient) {
...
export function withComputedAtypicalWorkRowTotal(row) {
...
export function collectAtypicalWorkArrayPaths(uiSchema, prefix = "") {
...
export function buildAtypicalWorkRowTotalRule(arrayPath) {
    return {
...
export function buildUnifiedAtypicalTotalRule(arrayPaths) {
...
export function patchV2AnketaCalculationLogicRules(logic, options) {
    return patchV2AtypicalWorksLogicRules(patchV2TypicalWorksLogicRules(logic, options), { uiSchema: options?.uiSchema });
}
/** Добавляет row_computed и unified-atypical-total для arch-блоков «Нетиповые работы». */
export function patchV2AtypicalWorksLogicRules(logic, options) {
...
export function collectAtypicalWorkRowsFromData(data, uiSchema) {
