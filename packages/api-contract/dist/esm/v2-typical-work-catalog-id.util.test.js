...
describe("remapFactoryAllowedWorkIdsToTemplateWorks", () => {
    ...
    it("maps factory registry ids to template work ids by name", () => {
        ...
        expect(remapFactoryAllowedWorkIdsToTemplateWorks([
    ...
    it("keeps ids unchanged when they already belong to the template", () => {
        ...
        expect(remapFactoryAllowedWorkIdsToTemplateWorks(["f8e3a1b2-4c5d-6e7f-8a9b-0c1d2e3f4004"], templateWorks, factoryRegistry)).toEqual(["f8e3a1b2-4c5d-6e7f-8a9b-0c1d2e3f4004"]);
    });
});
