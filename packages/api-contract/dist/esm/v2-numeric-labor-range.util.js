export const METRICS_COUNT_LABOR_RANGES = [
...
export function buildProductionAdditionalVitrinsLaborRows() {
    const rows = [
...
export function resolveNumericLaborPresetRows(paramName) {
...
export function buildNumericLaborCoefficientRows(preset, ctx) {
