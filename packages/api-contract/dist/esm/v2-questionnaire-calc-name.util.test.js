...
import { stripQuestionnaireCalcNameFromJsonSchema, stripQuestionnaireCalcNameFromTemplateSnapshot, stripQuestionnaireCalcNameFromUiSchema, } from "./v2-questionnaire-calc-name.util";
describe("stripQuestionnaireCalcNameFromTemplateSnapshot", () => {
    it("removes calcName from jsonSchema and uiSchema", () => {
        ...
        expect((snapshot.jsonSchema.properties?.generalInfo)
    ...
    it("leaves schema unchanged when calcName is absent", () => {
        ...
        expect(stripQuestionnaireCalcNameFromJsonSchema(jsonSchema)).toEqual(jsonSchema);
