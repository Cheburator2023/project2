...
export function binaryEnumKey(values) {
    return values
...
export function isBinaryBooleanEnum(values) {
    if (values.length !== 2)
        return false;
...
export function coerceBinaryBooleanFormValue(value) {
