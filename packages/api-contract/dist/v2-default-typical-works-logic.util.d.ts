...
export declare function buildSourceTypicalWorksCatalogRule(): V2LogicRuleDto;
...
export declare function patchV2TypicalWorksLogicRules(logic: V2LogicGraphDto): V2LogicGraphDto;
