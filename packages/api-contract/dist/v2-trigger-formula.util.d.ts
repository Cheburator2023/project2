...
export declare function matchTypicalWorkTriggers(input: TypicalWorkTriggerMatchInput, source: Record<string, unknown>, formData?: Record<string, unknown>): boolean;
