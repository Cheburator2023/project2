...
export declare function normalizeStreamBlockExecutors(value: unknown): V2ImplementationStreamCode[];
...
export declare function resolveStreamBlockExecutorsLabel(value: string | readonly string[] | undefined | null): string;
