...
exports.V2_TEMPLATE_AUDIT_ACTION_VALUES = [
    "template.created",
    "template.updated",
    "template.deleted",
    "version.created",
 ...
 */
exports.V2_LOGIC_RULE_KIND_VALUES = [
    "visibility",
    "required",
    "computed",
    "row_computed",
...
/* ------------------------------- Validation ------------------------------- */
exports.V2_VALIDATION_ISSUE_LEVEL_VALUES = [
    "error",
    "warning",
    "info",
];
 ...
 */
exports.V2_MAX_JSON_SCHEMA_BYTES = 1_048_576;
/**
