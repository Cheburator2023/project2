...
exports.V2_QUESTIONNAIRE_CALC_NAME_FORM_PATH = void 0;
exports.stripQuestionnaireCalcNameFromJsonSchema = stripQuestionnaireCalcNameFromJsonSchema;
exports.stripQuestionnaireCalcNameFromUiSchema = stripQuestionnaireCalcNameFromUiSchema;
exports.stripQuestionnaireCalcNameFromTemplateSnapshot = stripQuestionnaireCalcNameFromTemplateSnapshot;
/** Устаревший путь поля названия в formData шаблона (meta анкеты: entity.calcName). */
exports.V2_QUESTIONNAIRE_CALC_NAME_FORM_PATH = "generalInfo.calcName";
function isPlainRecord(value) {
    return Boolean(value) && typeof value === "object" && !Array.isArray(value);
}
/** Удаляет generalInfo.calcName из jsonSchema шаблона. */
function stripQuestionnaireCalcNameFromJsonSchema(jsonSchema) {
...
function stripQuestionnaireCalcNameFromUiSchema(uiSchema) {
...
function stripQuestionnaireCalcNameFromTemplateSnapshot(snapshot) {
    return {
        ...snapshot,
